...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !92, i64 0, metadata !37), !dbg !318
  %3 = icmp sgt i32 %numChars, 0, !dbg !318
  br i1 %3, label %bb.lr.ph, label %bb2, !dbg !318
...
bb:                                               ; preds = %bb, %bb.lr.ph
  ...
  %5 = add i8 %4, -32, !dbg !320
  %6 = icmp ult i8 %5, 95, !dbg !320
  %7 = zext i1 %6 to i64, !dbg !319
...
bb2:                                              ; preds = %bb, %entry
  %8 = sext i32 %numChars to i64, !dbg !322
  %9 = getelementptr inbounds i8* %2, i64 %8, !dbg !322
  store i8 0, i8* %9, align 1, !dbg !322
  ret i8* %2, !dbg !323
}
...
!1 = metadata !{i32 589865, metadata !"klee_init_env.c", metadata !"/home/klee/klee/runtime/POSIX/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_init_env.c", metadata !"/home/klee/klee/runtime/POSIX/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!320 = metadata !{i32 50, i32 0, metadata !321, metadata !319}
!321 = metadata !{i32 589835, metadata !0, i32 48, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!322 = metadata !{i32 72, i32 0, metadata !38, null}
!323 = metadata !{i32 73, i32 0, metadata !38, null}
